...
<template>
  <button v-bind="$attrs" :disabled="props.disabled" class="outline-primary p-2 relative duration-200 rounded-md ring-0"
    :class="[btnColor, btnButtonTextPosition]">
    <transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0" enter-to-class="opacity-100"
      leave-active-class="ease-in duration-200" leave-from-class="opacity-100" leave-to-class="opacity-0">
      <div class="absolute w-full h-full cursor-not-allowed bg-white -mt-2 -ml-2 rounded !bg-opacity-20"
